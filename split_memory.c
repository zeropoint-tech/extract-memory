...
int split_binary(FILE *file_bin_in, FILE *file_type_in,
                 FILE *file_filemapped_out, FILE *file_heap_out,
...
void usage() {
  printf("Usage: ./split_memdump path/to/memdump\n");
  printf("Params:\n");
  printf("        path: Path to binary to be split.\n");
}
